...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        if (auth()->user()->business->active_subscription) {
            if (auth()->user()->business->products->count() >= auth()->user()->business->active_subscription->package->product_limit) {
                $output = [
                    'success' => 0,
                    'msg' => __('Product limit reached! Please upgrade your package.'),
                ];
