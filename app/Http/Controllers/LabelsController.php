    ...
    public function preview(Request $request)
    {
        try {
            ...
            foreach ($products as $value) {
                ...
                // if (!empty($request->print['product_custom_label'])) {
                //     if (($details->product_custom_field1) != null) {
                //         $product_custom_label = $details->product_custom_field1;
                //     }
                // }
                
                // dd($request->print['product_custom_label']);
