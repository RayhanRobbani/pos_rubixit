...
class BusinessController extends Controller
{
    ...
    public function index()
    {
        ...
        $subscription_statuses = [
            ...
            '30' => __('superadmin.expiring_in_one_month'),
            '7' => __('superadmin.expiring_in_7_days'),
            '3' => __('superadmin.expiring_in_3_days'),
        ];

        $last_transaction_date = [
            'today' => __('home.today'),
            'yesterday' => __('superadmin.yesterday'),
            'this_week' => __('home.this_week'),
            'this_month' => __('home.this_month'),
            'last_month' => __('superadmin.last_month'),
    ...
    public function create()
    {
        ...
        return view('super_admin.business.create')
            ->with(compact(
                'currencies',
                'timezone_list',
                'accounting_methods',
