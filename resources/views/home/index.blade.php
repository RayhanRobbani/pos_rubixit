...
@section('content')
    ...
    <section class="content-header content-header-custom">
        <div style="display: flex; justify-content: space-between;">
            <h2 style="color: white;">{{ __('home.welcome_message', ['name' => Session::get('user.first_name')]) }}</h2>
            <div class="">
                <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ __('lang_v1.net_profit') }}
                                    @show_tooltip(__('lang_v1.net_profit_tooltip'))</span>
                                <span class="info-box-number net_profit"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
