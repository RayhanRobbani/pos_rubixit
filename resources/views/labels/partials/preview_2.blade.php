            ...
            <div
                ...
                <div>
                    ...
                    @if (!empty($print['product_custom_label']) && $page_product->product_custom_field1 != '')
                        <br> <span style="display: block; font-size:{{ $print['product_custom_label_size'] }}px">
                            {{ $page_product->product_custom_field1 }}
                    @endif

                    {{-- print barcode custom label  --}}
                    @if (!empty($print['custom_label_check']) && $print['custom_label'] != '')
                        <br> <span style="display: block; font-size:{{ $print['custom_label_size'] }}px">
                            {{ $print['custom_label'] }}
                    @endif
