...
@section('content')
    ...
    <section class="content-header">
        <h1 id="welcome-message">
            @lang('superadmin.welcome_superadmin')
        </h1>
    </section>
    ...
    <section class="content">
                ...
                <div class="btn-group pull-right" data-toggle="buttons">
                    ...
                    <label class="btn btn-info">
                        <input type="radio" name="date-filter" data-start="{{ $date_filters['this_yr']['start'] }}"
                            data-end="{{ $date_filters['this_yr']['end'] }}"> {{ __('superadmin.this_year') }}
                    </label>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    <div class="inner">
                        ...
                        <p>@lang('superadmin.new_subscriptions')</p>
                    </div>
                    <div class="icon">
         ...
         <a href="#" class="small-box-footer">@lang('superadmin.more_info')<i class="fa fa-arrow-circle-right"></i></a>
         </div>
         </div> -->
            <!-- ./col -->
            ...
            <div class="col-lg-4 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    <div class="inner">
                        ...
                        <p>@lang('superadmin.new_registrations')</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-4 col-xs-6">
                ...
                <div class="small-box bg-red">
                    <div class="inner">
                        ...
                        <p>@lang('superadmin.not_subscribed')</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-sm-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">{{ __('superadmin.monthly_sales_trend') }}</h3>
                    </div>
                    <div class="box-body">
