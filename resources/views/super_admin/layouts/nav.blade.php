    ...
    <nav class="navbar navbar-default bg-white m-4">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('superadmin.index') }}"><i class="fa fas fa-user-shield"></i>
                    {{ __('superadmin.superadmin') }}</a>
            </div>
