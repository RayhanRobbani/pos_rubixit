        ...
        <div class="navbar-custom-menu">
          ...
          @can('sell.create')
            <a href="{{action([\App\Http\Controllers\SellPosController::class, 'create'])}}" title="@lang('sale.pos_sale')" data-toggle="tooltip" data-placement="bottom" class="btn btn-flat pull-left m-8 btn-sm mt-10 btn-success">
              <strong style="font-size:20px"> @lang('sale.pos_sale')</strong>
            </a>
          @endcan
        @endif --}}
            @can('purchase.create')
                <a style="font-size: 16px;margin-right: 5px; font-size:15px"
                    href="{{ action([\App\Http\Controllers\PurchaseController::class, 'create']) }}"
                    title="@lang('purchase.add_purchase')" data-toggle="tooltip" data-placement="bottom"
            ...
            @if (in_array('pos_sale', $enabled_modules))
                @can('sell.create')
                    <a style="font-size: 16px; margin-right: 5px;"
