<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="modalTitle"> @lang('lang_v1.damage_return_details') (<b>@lang('purchase.ref_no'):</b>
            ...
            <div class="row">
                @if (!empty($purchase->return_parent))
                    <div class="col-sm-6 col-xs-6">
                        <h4>@lang('lang_v1.damage_return_details'):</h4>
                        ...
                        <tbody>
                            ...
                            @foreach ($purchase->purchase_lines as $purchase_line)
                                ...
                                <tr>
                                    ...
                                    <td>{{ @format_quantity($purchase_line->quantity_damage_returned) }} {{ $unit_name }}
                                    </td>
                                    <td>
                                        @php
                                            $line_total =
