...
@section('content')
    ...
    <section class="content no-print">
        ...
        @endcomponent
        @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_damage_returns')])
            @can('purchase.update')
                @slot('tool')
                    <div class="box-tools">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on(
                ...
                #purchase_list_filter_supplier_id ',
                function() {
                    purchase_return_table.ajax.reload();
                }
            );
