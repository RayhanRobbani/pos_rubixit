                ...
                <div class="@if (!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            @if (session('business.default_supplier'))
                                @php
                                    $supplier = $suppliers->where('id', session('business.default_supplier'))->first();
                                @endphp
                                {!! Form::text('supplier', $supplier->text, [
                                    'class' => 'form-control',
                                    'readonly',
                                ]) !!}
                                {!! Form::hidden('contact_id', $supplier->id) !!}
                            @else
