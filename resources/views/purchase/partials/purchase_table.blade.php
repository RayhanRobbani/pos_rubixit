    ...
    <tfoot>
        <tr class="bg-gray font-17 text-center footer-total">
            ...
            <td class="text-left"><small>@lang('report.purchase_due') - <span class="footer_total_due"></span><br>
                    @lang('lang_v1.purchase_return') - <span class="footer_total_purchase_return_due"></span><br>
                    @lang('lang_v1.damage_return') - <span class="footer_total_purchase_damage_return_due"></span>
                </small></td>
            <td></td>
        </tr>
    </tfoot>
