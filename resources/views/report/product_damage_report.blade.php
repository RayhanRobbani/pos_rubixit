@extends('layouts.app')
@section('title', __('lang_v1.product_damage_report'))

@section('content')

    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>{{ __('lang_v1.product_damage_report') }}</h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                @component('components.filters', ['title' => __('report.filters')])
                    {!! Form::open([
                        'url' => action([\App\Http\Controllers\ReportController::class, 'getproductDamageReport']),
                        'method' => 'get',
                        'id' => 'product_damage_report_form',
                    ]) !!}
                    <div class="col-md-3">
            ...
            <div class="col-md-12">
                @component('components.widget', ['class' => 'box-primary'])
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="product_damage_report_table">
                            <thead>
                                <tr>
