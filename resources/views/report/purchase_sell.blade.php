            ...
            <div class="col-xs-6">
                @component('components.widget', ['title' => __('purchase.purchases')])
                    <table class="table table-striped">
                        ...
                        <tr>
                            <th>{{ __('lang_v1.total_damage_return_inc_tax') }}:</th>
                            <td>
                                <span class="damage_return_inc_tax">
                                    <i class="fas fa-sync fa-spin fa-fw"></i>
                                </span>
                            </td>
                        </tr>
        ...
        <div class="row">
            <div class="col-xs-12">
                @component('components.widget')
                    @slot('title')
                        {{ __('lang_v1.overall') }}
                        ((@lang('business.sale') - @lang('lang_v1.sell_return')) - (@lang('lang_v1.purchase') - @lang('lang_v1.purchase_return') - @lang('lang_v1.damage_return')) )
