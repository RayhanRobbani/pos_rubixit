    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title no-print">
                ...
                (
                @if (in_array($transaction->type, ['purchase', 'expense', 'purchase_return', 'purchase_damage_return', 'payroll']))
        ...
        <div class="modal-body">
            @if (in_array($transaction->type, ['purchase', 'purchase_return', 'purchase_damage_return']))
                        ...
                        @if (
                            (auth()->user()->can('hms.add_booking_payment') && in_array($transaction->type, ['hms_booking'])) ||
                                (auth()->user()->can('purchase.payments') &&
                                    in_array($transaction->type, ['purchase', 'purchase_return', 'purchase_damage_return'])) ||
